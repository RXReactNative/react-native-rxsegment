...
# 目录中的文件名 是否 为 react-navigation的资源，是就删除
...
# 删除Android 中react-navigation 的图片资源
...
# 如果 react-navigation 使用默认的导航，就不能执行下面的删除图片资源
